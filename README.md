...
[![Downloads from the RStudio CRAN mirror per M=month](https://cranlogs.r-pkg.org/badges/RagGrid)](https://cran.r-project.org/package=RagGrid)
[![Downloads from the RStudio CRAN mirror grant total](https://cranlogs.r-pkg.org/badges/grand-total/RagGrid)](https://cran.r-project.org/package=RagGrid)
